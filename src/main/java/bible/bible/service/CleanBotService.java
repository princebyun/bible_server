...
public class CleanBotService {
    ...
    public CleanBotResult checkContent(String userText) {
        ...
        try {
            ...
            OllamaRequest request = new OllamaRequest("llama3.2", Collections.singletonList(message));
            ...
            e.printStackTrace();
            throw new RuntimeException("Llama API 호출 실패: " + e.getMessage());
        }
    }
    ...
    public CleanBotResult checkImage(MultipartFile file) {
        ...
        try {
            ...
            OllamaRequest request = new OllamaRequest("llava-phi3", Collections.singletonList(message));
            ...
            e.printStackTrace();
            throw new RuntimeException("llava-phi3 이미지 분석 실패: " + e.getMessage());
        }
    }
}